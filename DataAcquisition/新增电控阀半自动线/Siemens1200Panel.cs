        ...
        private void AquireWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            while (bWorking)
            {
                try
                {
                    ...
                    //string sql = string.Format("update Siemens1200RealtimeData set PS_Value_1 ={0},PD_Value_1={1},PC_Value_1={2},PC_Reduce_PS_Value_1={3},PS_SettingValue={4} where Number=1", dic["PS_Value_1"], dic["PD_Value_1"], dic["PC_Value_1"], dic["PC_Reduce_PS_Value_1"], dic["PS_SettingValue"]);
